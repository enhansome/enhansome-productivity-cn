...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,102 | 🐛 100 | 📅 2026-06-30
...
>
> 感谢 jyguyomarch 的 [awesome-productivity](https://github.com/jyguyomarch/awesome-productivity) ⭐ 3,330 | 🐛 179 | 📅 2024-08-14，本单受其启发，并使用其作为最初始清单。
...
* [Preserver](https://github.com/hsbalar/preserver) ⭐ 216 | 🐛 2 | 🌐 TypeScript | 📅 2020-10-16 – 基于 Electron 的笔记管理器桌面应用程序。
...
* [NodeNote](https://github.com/yetao0806/NodeNote) ⭐ 323 | 🐛 5 | 🌐 Python | 📅 2024-11-07 - 支持 markdown 和无限画布的嵌套类型图形化笔记应用。
...
* [Topydo](https://github.com/topydo/topydo) ⭐ 934 | 🐛 81 | 🌐 Python | 📅 2026-03-18 – 使用 todo.txt 格式的强大的待办事项列表应用程序，位于 todo.txt CLI 和 Taskwarrior 之间。
* [Pomolectron](https://github.com/amitmerchant1990/pomolectron) ⭐ 639 | 🐛 22 | 🌐 JavaScript | 📅 2025-01-28 – 菜单栏/托盘的番茄钟应用程序。
...
* [Loop Habit Tracker](https://github.com/iSoron/uhabits) ⭐ 10,133 | 🐛 48 | 🌐 Kotlin | 📅 2026-07-21 – 一个用于创建和保持良好习惯的 Android 应用程序。
...
* [IFTTT](https://ifttt.com) – 允许您在 Web 服务之间创建条件语句链（称为 *recipes*），以使 Web 为您服务并提高您的生产力。
...
* [AutoHotKey](https://github.com/Lexikos/AutoHotkey_L) ⭐ 12,943 | 🐛 22 | 🌐 C++ | 📅 2026-08-15(*Win*) - 即大名鼎鼎的 AHK，优秀**开源**的自动化软件，时常会在别的地方见到他人分享的 AHK 宏脚本。

### 启动器

> 启动器让你输入简单的命令就可执行一系列操作

* [Flow Launcher](https://github.com/Flow-Launcher/Flow.Launcher) ⭐ 15,365 | 🐛 302 | 🌐 C# | 📅 2026-08-15(*Win*) - Listary 的**开源**替代品，开发活跃插件众多，例如可调用 Everything 快速搜索文件、可自定义网络搜索引擎等。
* [Playnite](https://github.com/JosefNemec/Playnite) ⭐ 13,758 | 🐛 706 | 🌐 C# | 📅 2026-08-14(*Win*) - 将众多游戏平台和模拟器平台全合一的数据库式**开源**游戏管理启动器，开发活跃插件众多，例如可借助**Flow Launcher**快速启动游戏。理论上也可用于管理本地软件。
* [Lutris](https://github.com/lutris/lutris) ⭐ 10,153 | 🐛 293 | 🌐 Python | 📅 2026-08-14(*Linux*) - 类似于 Playnite（侧重稍有不同）但更悠久，且作为 Linux 上的**开源**软件，还同时集成了 Wine 的功能。
...
* [KeePassXC](https://github.com/keepassxreboot/keepassxc) ⭐ 28,398 | 🐛 891 | 🌐 C++ | 📅 2026-08-12(*跨平台*) - 作为老牌 Win 平台软件 KeePass 的美化 + 跨平台版，与前者一样**开源**，采用\*.kdbx 数据库文件但采用 4.0 标准。支持各主流浏览器插件方便随时调用。
* [花蜜](https://shansing.com/passwords/) - 使用两个有意义的片段来生成密码，方便记忆和找回。 [使用方法见讨论](https://github.com/eastlakeside/awesome-productivity-cn/issues/7) ⭐ 2,813 | 🐛 13 | 📅 2022-08-08
...
* [OBS Studio](https://github.com/obsproject/obs-studio) ⭐ 75,044 | 🐛 1,173 | 🌐 C | 📅 2026-08-15(*跨平台*) - 口碑积淀最深厚（没有之一）的强大**开源**录屏工具。
* [ScreenToGif](https://github.com/NickeManarin/ScreenToGif/) ⭐ 27,475 | 🐛 327 | 🌐 C# | 📅 2026-07-28 - 一款录屏为 GIF 的工具，仅支持 Windows。
* [Krita](https://github.com/KDE/krita) ⭐ 10,217 | 🐛 0 | 🌐 C++ | 📅 2026-08-15 - 在绘画方面替代甚至超越 Photoshop 的优秀**开源**软件。著名开源社区 KDE 的作品之一。也可用于制作动画。
* [Gimp](https://github.com/GNOME/gimp) ⭐ 6,356 | 🐛 0 | 🌐 C | 📅 2026-08-15 - 能够在图像处理方面替代 Photoshop 的优秀**开源**软件。著名开源社区 GNOME 的作品之一。
...
* [scrcpy](https://github.com/Genymobile/scrcpy) ⭐ 147,702 | 🐛 2,879 | 🌐 C | 📅 2026-08-14(*Win*) - 通过有线或无线安卓调试桥在电脑上查看并操作手机屏幕的**开源**工具。很多的所谓同类产品实际上是它的套壳。
* [Bartender](https://www.macbartender.com/) - Macos 菜单栏图标管理，建议购买[setapp](https://setapp.com/)应用包，性价比更高，或者试试更为小巧的开源产品[Dozer](https://github.com/Mortennn/Dozer) ⭐ 8,719 | 🐛 100 | 🌐 Swift | 📅 2023-11-30。
